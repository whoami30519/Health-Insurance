			...
			>
				...
				<div style={{ display: "flex", gap: "8px", marginTop: "10px" }}>
					...
					>
						...
						>
							...
							<div style={{ fontSize: "24px" }}>
								{formatCurrency(totalAmountOfRegistration)}
							</div>
						</div>
					</div>
					...
					>
						...
						>
							<TrendingDownIcon style={{ marginRight: "8px" }} />
							<div style={{ fontSize: "24px" }}>
								{formatCurrency(totalAmountOfRefund)}
							</div>
						</div>
					</div>
				...
				<div style={{ display: "flex", gap: "8px" }}>
					...
					<FormControl style={{ margin: "10px", width: "33%" }}>
